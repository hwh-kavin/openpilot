...
export const RoutesView = ({ deviceStatus = 'checking' }: RoutesViewProps) => {
  ...
  const handlePreserveToggle = async (e: React.MouseEvent, baseName: string) => {
    ...
    if (isCurrentlyPreserved) {
      ...
      try {
        ...
        addToast(t('routes.preserveSuccess'), 'success')
      } catch (error: any) {
  ...
  const handleConfirmUnpreserve = async () => {
    ...
    try {
      ...
      addToast(t('routes.unpreserveSuccess'), 'success')
    } catch (error: any) {
  ...
  const handleConfirmDelete = async () => {
    ...
    try {
      ...
      addToast(t('routes.deleteSuccess'), 'success')
    } catch (error: any) {
  ...
  return (
    <>
      ...
      <ConfirmDialog
        ...
        message={t('routes.deleteMessage')}
      ...
      <ConfirmDialog
        ...
        title={t('routes.unpreserveTitle')}
        message={t('routes.unpreserveMessage')}
        confirmText={t('routes.unpreserve')}
        cancelText={t('common.cancel')}
        variant="warning"
      />
      {selectedRoute && (
                        ...
                        <div className="route-info">
                          ...
                          <div className="route-actions">
                            <button
                              ...
                              title={preserved ? t('routes.preserved') : t('routes.preserve')}
                              onClick={(e) => handlePreserveToggle(e, baseName)}
                            >
                              <Icon name={preserved ? 'star' : 'star_outline'} size={14} />
                              <span>{preserved ? t('routes.preserved') : t('routes.preserve')}</span>
                            </button>
                            <button
                              type="button"
