...
export const ParametersView = ({ deviceStatus = 'checking' }: ParametersViewProps) => {
  ...
  const sortOptions = useMemo(
    () => [
      { label: t('params.col.key'), value: 'key' as SortColumn },
      { label: t('params.col.value'), value: 'value' as SortColumn },
      { label: t('params.col.type'), value: 'type' as SortColumn },
      { label: t('params.col.category'), value: 'category' as SortColumn },
      { label: t('params.col.modified'), value: 'last_modified' as SortColumn },
    ],
    [t],
  )
  ...
  const copyToClipboard = (text: string, label: string = 'Value') => {
    navigator.clipboard
      .writeText(text)
      .then(() => {
        addToast(t('params.copied', { label }), 'success')
      })
      .catch(() => {
        addToast(t('params.copyFailed'), 'error')
      })
  }
    ...
    return (
      <>
        ...
        <div className="loading">
          <LoadingSpinner size="large" message={t('params.loading')} />
        </div>
      </>
    )
  }
  ...
  return (
    <>
      <Header deviceStatus={deviceStatus} subtitle={t('params.subtitle')} />
          ...
          <div className="params-controls">
            <div className="params-sort-controls">
              ...
              <button
                ...
                title={t('params.sortOrder', {
                  direction: sortDirection === 'asc' ? t('common.descending') : t('common.ascending'),
                })}
              >
            ...
            <ToggleSwitch
              ...
              label={t('params.editMode')}
              size="compact"
              alignLabel="start"
              className={`params-edit-toggle ${editMode ? 'active' : ''}`}
              title={t('params.editModeHint')}
            />
            <input
              type="text"
              id="params-search"
                  ...
                  <div className="param-row" key={param.key}>
                    <div className="param-row__header">
                      <div className="param-row__title-block">
                        <div className="param-row__title-line">
                          <span className="param-key" title={param.key} data-param-key={param.key}>
                      ...
                      <div className="param-row__actions">
                        {param.readonly ? (
                          ...
                          <Button
                            ...
                            title={param.type === 'bytes' ? t('params.binaryViewOnly') : undefined}
                          >
                            Edit
                          </Button>
                        )}
                    ...
                    {param.description && (
                      <div className="param-description">
                        <span className="description-label">{t('params.description')}</span>
