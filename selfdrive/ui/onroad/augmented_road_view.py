...
class AugmentedRoadView(CameraView, AugmentedRoadViewSP, BlindspotRendererMixin):
  ...
  def set_draw_border(self, enabled: bool) -> None:
    self._draw_border_enabled = enabled
  ...
  def _render(self, rect):
    ...
    if self._draw_border_enabled:
      ...
      self._content_rect = rl.Rectangle(rect.x, rect.y, rect.width, rect.height)
...
def draw_onroad_border(rect: rl.Rectangle) -> None:
