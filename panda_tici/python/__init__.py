...
class Panda:
  ...
  # BluePilot: comma three built-in red panda (hwj dp260513 + C3 fix)
  INTERNAL_DEVICES = (HW_TYPE_UNO, HW_TYPE_DOS, HW_TYPE_RED_PANDA, HW_TYPE_RED_PANDA_V2, HW_TYPE_TRES, HW_TYPE_CUATRO)
  # End BluePilot
  ...
  def usb_connect(cls, serial, claim=True, no_error=False):
    ...
    return context, usb_handle, usb_serial, bootstub, bcd_hw_type
