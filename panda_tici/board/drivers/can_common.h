...
// BluePilot: F4 has 256KB SRAM + 64KB CCM; 4096-slot CAN-FD packets overflow .bss
#define CAN_RX_BUFFER_SIZE_F4 896U
#undef CAN_RX_BUFFER_SIZE
#define CAN_RX_BUFFER_SIZE CAN_RX_BUFFER_SIZE_F4
__attribute__((section(".ccmram"))) can_buffer(rx_q, CAN_RX_BUFFER_SIZE)
